    ...
    mobile_nav = rx.box(
        rx.menu.root(
            ...
            rx.menu.content(
                ...
                rx.menu.item("AI", on_click=rx.redirect("/capabilities/ai")),
                rx.menu.item("HPC", on_click=rx.redirect("/capabilities/hpc")),
                rx.menu.item("Government", on_click=rx.redirect("/capabilities/government")),
                rx.menu.separator(),
                rx.text("RESEARCH", padding="8px 12px", color="#DFBC61", font_size="0.75rem", font_weight="bold", letter_spacing="0.1em"),
                rx.menu.item("Research Log", on_click=rx.redirect("/research/log")),
                rx.menu.item("Published Papers", on_click=rx.redirect("/research/papers")),
                rx.menu.separator(),
                rx.text("COMPANY", padding="8px 12px", color="#DFBC61", font_size="0.75rem", font_weight="bold", letter_spacing="0.1em"),
                rx.menu.item("Mission", on_click=rx.redirect("/company/mission")),
                rx.menu.item("Careers", on_click=rx.redirect("/company/careers")),
                rx.menu.item("Staff Directory", on_click=rx.redirect("/company/directory")),
                rx.menu.item("Contact Us", on_click=rx.redirect("/contact")),
                rx.menu.separator(),
                rx.menu.item("DEVELOPER PORTAL", on_click=rx.redirect("/developer"), color="white", font_weight="bold"),
