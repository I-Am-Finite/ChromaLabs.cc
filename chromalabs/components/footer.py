...
def footer() -> rx.Component:
    return rx.box(
        ...
        rx.grid(
            ...
            footer_section("PRODUCTS", [("Photonic Core", "/products/hardware"), ("Volumetric Router", "/products/hardware"), ("API Docs", "/docs")]),
            footer_section("SOLUTIONS", [("Defense & Aerospace", "/solutions/defense"), ("Hyperscale AI", "/solutions/hyperscale")]),
            footer_section("COMPANY", [("Mission", "/company/mission"), ("Careers", "/company/careers"), ("Contact", "/contact")]),
            columns="4",
            spacing="8",
            padding_y="16",
            padding_x="6",
