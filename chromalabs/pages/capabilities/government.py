...
def government() -> rx.Component:
    return base_layout(
        rx.box(
            rx.vstack(
                rx.text("The Tactical Edge", font_family="JetBrains Mono, monospace", font_size="1rem", color="#D4AF37", margin_bottom="4", letter_spacing="0.1em"),
                rx.text("GOVERNMENT & LAW ENFORCEMENT", font_size=["2.5rem", "3.5rem", "4.5rem", "5rem"], font_weight="800", line_height="1.1", color="white", letter_spacing="-0.03em", margin_bottom="8", text_align="center"),
                rx.text(
                ...
                rx.grid(
                    ...
                    rx.box(
                        rx.icon(tag="radio", color="#D4AF37", size=32, margin_bottom="6"),
                        rx.text("Signal Intelligence", font_size="1.5rem", font_weight="bold", color="white", margin_bottom="4"),
                        rx.text("Edge-native processing of vast RF data streams, enabling real-time threat identification without continuous satellite uplinks.", color="slate.10", font_size="1.1rem", line_height="1.6"),
                        padding="40px", background="rgba(255, 255, 255, 0.02)", border="1px solid rgba(255, 255, 255, 0.05)", border_radius="8px"
                    ),
                    rx.box(
                        rx.icon(tag="shield", color="#D4AF37", size=32, margin_bottom="6"),
                        rx.text("Zero-Trust Sovereignty", font_size="1.5rem", font_weight="bold", color="white", margin_bottom="4"),
                        rx.text("Absolute physical compartmentalization. Complete elimination of software-layer side-channel vulnerabilities at the hardware level.", color="slate.10", font_size="1.1rem", line_height="1.6"),
                        padding="40px", background="rgba(255, 255, 255, 0.02)", border="1px solid rgba(255, 255, 255, 0.05)", border_radius="8px"
                    ),
