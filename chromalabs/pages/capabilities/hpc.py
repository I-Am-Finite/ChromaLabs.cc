...
def hpc() -> rx.Component:
    return base_layout(
        rx.box(
            ...
            rx.vstack(
                rx.text("SYS.REQ // CHROMA_HPC_02", font_family="JetBrains Mono, monospace", font_size="0.8rem", color="#D4AF37", margin_bottom="4", letter_spacing="0.1em"),
                rx.text("THERMODYNAMIC SUPREMACY", font_size=["3rem", "4rem", "5rem"], font_weight="800", line_height="1.1", color="white", letter_spacing="-0.03em", margin_bottom="8", text_align="center"),
                rx.text(
                ...
                rx.grid(
                    ...
                    rx.box(
                        rx.icon(tag="server", color="white", size=32, margin_bottom="6"),
