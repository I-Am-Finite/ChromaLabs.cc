...
def index() -> rx.Component:
    return base_layout(
        rx.box(
            rx.vstack(
                rx.image(src="/logo_glyph.svg?v=1", height="100px", width="auto", margin_bottom="30px", style={"filter": "drop-shadow(0px 10px 15px rgba(0,0,0,0.8))"}, class_name="animate-fade-up"),
                rx.text(
                    ...
                    color="white", text_align="center", class_name="animate-fade-up delay-100", margin_top="12",
